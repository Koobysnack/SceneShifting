    ...
    create() {
        ...
        this.physics.world.on('worldbounds', (body, blockedUp, blockedDown, blockedLeft, blockedRight) => {
            if (blockedUp) {
                ...
                this.player.body.reset(this.player.body.x+this.player.body.halfWidth, this.player.body.y - 20);
            }
                ...
                this.physics.world.setBounds(this.ROOMWIDTH * 2, this.ROOMHEIGHT, this.ROOMWIDTH, this.ROOMHEIGHT);
                this.player.body.reset(this.player.body.width, this.player.body.y + this.player.body.halfHeight)
            }
            else if(blockedLeft) {
                this.cameras.main.flash(250);
                this.cameras.main.shake(250)
                ...
                this.physics.world.setBounds(0, this.ROOMHEIGHT, this.ROOMWIDTH, this.ROOMHEIGHT);
                this.player.body.reset(this.player.body.x - this.player.body.width, this.player.body.y + this.player.body.halfHeight);
            }           
            else if(blockedDown) {
                console.log('down')
                this.cameras.main.flash(250);
                ...
                this.physics.world.setBounds(this.ROOMWIDTH, this.ROOMHEIGHT, this.ROOMWIDTH, this.ROOMHEIGHT);
                this.player.body.reset(this.player.body.x, 20);
            }
        });
